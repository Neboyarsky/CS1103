package Week1.RA_W1.BirthdayProblem;
...
public class BirthdayProblemV2 {
     ...
     */
    private static void countBirthdays() {
        ...
        for (boolean tried : used) {
            // Select a birthday at random, from 0 to 364.
            // If the birthday has already been used, quit.
            // Otherwise, record the birthday as used.
            int birthday = (int)(Math.random()*365); // randomly selected birthday
