...
public class WordListWithTreeSet {
     ...
     * A word is defined as a sequence of letters.  Also, a word can inlcude
     * an apostrophy if the apostrophy is surrounded by letters on each side.
    ...
    private static String readNextWord() {
        ...
        while (true) {
            ...
            if ( ch == '\'' ) {
                // The next character is an apostrophy.  Read it, and
                // if the following character is a letter, add both the
                // apostrophy and the letter onto the word and continue
                // reading the word.  If the character after the apostrophy
                // is not a letter, the word is done, so break out of the loop.
                TextIO.getAnyChar();   // Read the apostrophy.
                ch = TextIO.peek();    // Look at char that follows apostrophy.
