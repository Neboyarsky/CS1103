...
public class ReverseFile {
    public static void main(String[] args) {
        ...
        String filePath = "/src/Week6/";
        ArrayList<Double> numbers; // An ArrayList for holding the data.
        numbers = new ArrayList<Double>();
        try { // Create the input stream.
            data = new TextReader(new FileReader(System.getProperty("user.dir") + filePath + "data.dat"));
        }
        ...
        try { // Create the output stream.
            result = new PrintWriter(new FileWriter(filePath + "result.dat"));
        }
        catch (IOException e) {
